...
function App() {
  ...
  const pressNumber = number => {
    if (displayNumber == 0) setDisplayNumber(number);
    else {
      setDisplayNumber(displayNumber + "" + number);
    }
  };

  const pressSpecial = (special)=>{
    switch(special){
      case '+/-':
      console.log('+/-');
      break;
      ...
      case '%':
        ...
        break;
      default:
        console.log('This function needs to take a special button')
    }
  }
      ...
      <div className="App">
        ...
        <div className="buttons-container">
          <div className="numbers-container">
            <Specials pressSpecial={pressSpecial} />
